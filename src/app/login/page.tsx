  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md bg-[#1a1a1a] p-8 rounded-2xl border border-[#333]">
        <h1 className="text-3xl font-bold font-poppins mb-2 text-center">Iniciar Sesión</h1>
        <p className="text-gray-400 text-center mb-8">Ingresa a tu cuenta de Justo Talent</p>
        ...
        <div className="mt-6 text-center text-sm text-gray-400">
          ...
          <Link href="/register" className="text-justo-green font-semibold hover:underline">
            Regístrate aquí
          </Link>
        </div>
      </div>
